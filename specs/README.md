...
| [`021`](file:///d:/TcsQET/qet-react-ui/specs/021-upload-logging-and-gemini-json-resilience/README.md) | **Upload Observability & Gemini JSON Resilience Engine** | Real-time live upload logging across frontend and backend, token capacity expansion to 8192 for thinking tiers, native JSON mode (`responseMimeType`), and auto-repair parser. |
| [`022`](file:///d:/TcsQET/qet-react-ui/specs/022-testcase-datagen-scriptviewer-and-selective-execution/README.md) | **Test Case & Synthetic Data Intelligence, Script Visibility & Selective Execution** | Playwright script modal viewer, synthetic data inspector per case, collapsible intake lanes, category filter pills, and selective test case execution. |
| [`023`](file:///d:/TcsQET/qet-react-ui/specs/023-e2e-playwright-evidence-and-grounded-intelligence/README.md) | **End-to-End Playwright Automation, Evidence Capture & Grounded Intelligence** | AST-grounded selectors, modular standalone script per test case, auto screenshot on pass/fail, Allure/HTML/PDF reporting, testing domain badges, and in-lane stage progression buttons. |
| [`024`](file:///d:/TcsQET/qet-react-ui/specs/024-agent-pipeline-architectural-redesign/README.md) | **Agent Pipeline Architectural Redesign — 6-Agent Hierarchical Pipeline** | Complete redesign into 6 agents: Application Understanding (3 sub-agents), Test Case Generation, Data Generation (AI+Upload), Test Script, Execute, Dashboard. Removes sample data, top-nav tabs, and separate execution page. 7 sub-feature folders with comprehensive requirement files. |
