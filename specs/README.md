...
| [`022`](file:///d:/TcsQET/qet-react-ui/specs/022-testcase-datagen-scriptviewer-and-selective-execution/README.md) | **Test Case & Synthetic Data Intelligence, Script Visibility & Selective Execution** | Interactive Playwright code viewer modal, synthetic test data inspector, collapsible intake workspace, and granular checkbox execution. |
| [`023`](file:///c:/Users/AkshatSinha/Documents/avd/qet-react-ui/specs/023-multi-modal-testing-and-execution-intelligence/README.md) | **Multi-Modal Testing Expansion & Executive Quality Reporting** | Multi-phase testing tabs (UI, API, Performance, Accessibility), ReportLab PDF / HTML report downloads, and automated GO / NO-GO release gate. |
